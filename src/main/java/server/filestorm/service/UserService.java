...
public class UserService {
     ...
     */
    public User findById(Integer userId) throws AuthenticationException {
        return userRepository.findById(userId)
                .orElseThrow(() -> new AuthenticationException("User not found."));
    }

    @Transactional
    public User addRootDirectory(User user, DirectoryReference dirRef) {
        // User user = this.findById(userId);
        user.setStorageDirectory(dirRef);
